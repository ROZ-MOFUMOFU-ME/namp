 ...
 * Modified  (c) 2018 Aion Foundation
 * Modified  (c) 2018 hellcatz
 *
...
public:
    ...
    int InitialiseState(blake2b_state *base_state, const char* personalizationString);
...
#define EhInitialiseState(n, k, base_state, personalizationString)  \
    if (n == 210 && k == 9) {                                       \
        Eh210_9.InitialiseState(base_state, personalizationString); \
    } else if (n == 200 && k == 9) {                                \

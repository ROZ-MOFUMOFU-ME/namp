// Modified 2018 hellcatz
// Modified 2017-2018 AION Foundation 
...
int Equihash<N,K>::InitialiseState(blake2b_state *base_state, const char* personalizationString)
{
    ...
    memcpy(P->personal, (const uint8_t *)personalization, 16);
    return eh_blake2b_init_param(base_state, P);
}

void GenerateHash(blake2b_state *base_state, eh_index g,
                  unsigned char* hash, size_t hLen)
{
    blake2b_state state = *base_state;
    eh_index lei = htole32(g);
    eh_blake2b_update(&state, (const unsigned char*) &lei,
                                      sizeof(eh_index));
    eh_blake2b_final(&state, hash, hLen);
}
...
/*
 * SUPPORTED EQUIHASH PARAMETERS
 */

template int Equihash<210,9>::InitialiseState(blake2b_state *base_state, const char* personalizationString);
template bool Equihash<210,9>::IsValidSolution(blake2b_state *base_state, std::vector<unsigned char> soln);

template int Equihash<200,9>::InitialiseState(blake2b_state *base_state, const char* personalizationString);
template bool Equihash<200,9>::IsValidSolution(blake2b_state *base_state, std::vector<unsigned char> soln);

template int Equihash<144,5>::InitialiseState(blake2b_state *base_state, const char* personalizationString);
template bool Equihash<144,5>::IsValidSolution(blake2b_state *base_state, std::vector<unsigned char> soln);

template int Equihash<96,5>::InitialiseState(blake2b_state *base_state, const char* personalizationString);
template bool Equihash<96,5>::IsValidSolution(blake2b_state *base_state, std::vector<unsigned char> soln);

template int Equihash<96,3>::InitialiseState(blake2b_state *base_state, const char* personalizationString);
template bool Equihash<96,3>::IsValidSolution(blake2b_state *base_state, std::vector<unsigned char> soln);

template int Equihash<48,5>::InitialiseState(blake2b_state *base_state, const char* personalizationString);
template bool Equihash<48,5>::IsValidSolution(blake2b_state *base_state, std::vector<unsigned char> soln);

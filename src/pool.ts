        ...
        _this.jobManager
            ...
            .on('updatedBlock', function (blockTemplate: any) {
                ...
                if (_this.stratumServer) {
                    ...
                    // cleanJobs flag index differs by coin family: standard stratum
                    // notify carries it at params[8], but vipstar/qtum shifts it to
                    // params[10] because [8]/[9] hold hashstateroot/hashutxoroot (see
